...
module.exports = exports['default'];
},{"../../utils/isPrefixedValue":16,"../../utils/joinPrefixedValue":17}],4:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../../utils/joinPrefixedValue":17}],5:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../../utils/isPrefixedValue":16,"../../utils/joinPrefixedValue":17}],9:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../../utils/joinPrefixedValue":17}],11:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../../utils/capitalizeString":14,"../../utils/isPrefixedValue":16,"../prefixProps":13,"hyphenate-style-name":2}],12:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../utils/capitalizeString":14,"../utils/sortPrefixedStyle":18,"./plugins/calc":3,"./plugins/cursor":4,"./plugins/flex":5,"./plugins/flexboxIE":6,"./plugins/flexboxOld":7,"./plugins/gradient":8,"./plugins/position":9,"./plugins/sizing":10,"./plugins/transition":11,"./prefixProps":13}],13:[function(require,module,exports){
"use strict";
...
module.exports = exports['default'];
},{"./isPrefixedProperty":15}],19:[function(require,module,exports){
module.exports = require('./lib/static/prefixAll')

},{"./lib/static/prefixAll":12}],20:[function(require,module,exports){
module.exports={
	"version": "2016j",
	"zones": [
...
var _prefixedEvent = require('prefixed-event');

var _prefixedEvent2 = _interopRequireDefault(_prefixedEvent);
...
function applyCSSAnimation(element, animation, time, opts) {
  ...
  var animationString = animation + ' ' + time + ' ' + (opts.delay || '') + ' ' + (opts.timingFunction || '') + ' ' + (opts.iterationCount || '') + ' ' + (opts.direction || '') + ' ' + (opts.fillMode || '') + ' ' + (opts.playState || '');
  var promise = new Promise(function (resolve, reject) {
    _prefixedEvent2.default.add(element, 'AnimationEnd', function (e) {
      if (e.target === element) {
        _prefixedEvent2.default.remove(element, 'AnimationEnd');
        resolve(element);
      }
    });
    Object.assign(element.style, (0, _static2.default)({ animation: animationString }));
  });

  return promise;
}

module.exports = { applyCSSAnimation: applyCSSAnimation };

},{"inline-style-prefixer/static":19,"prefixed-event":24}],28:[function(require,module,exports){
'use strict';
...
var _SATUtils = require('./SATUtils.js');

var _SATUtils2 = _interopRequireDefault(_SATUtils);
...
var DiamondMaskTransition = function () {
  ...
  function DiamondMaskTransition(keyframer) {
    _classCallCheck(this, DiamondMaskTransition);
  ...
  _createClass(DiamondMaskTransition, [{
    key: 'addListeners',
    value: function addListeners() {
      var _this = this;

      window.onresize = function (event) {
        _this.generateDiamonds();
        _this.createAndRegisterDefaultAnimations();
      };
    }
  }, {
    key: 'generateDiamonds',
    value: function generateDiamonds() {
      var windowPoly = new _sat2.default.Box(new _sat2.default.Vector(), window.innerWidth, window.innerHeight).toPolygon();

      var top = new _sat2.default.Vector(window.innerWidth / 2, window.innerHeight / 2 + 1),
          right = new _sat2.default.Vector(1, 1),
          bottom = new _sat2.default.Vector(0, 2),
          left = new _sat2.default.Vector(-1, 1);

      var start = new _sat2.default.Polygon(top, [new _sat2.default.Vector(), right, bottom, left]);
      var verticalFill = void 0;
      var horizontalFill = void 0;
      var end = _SATUtils2.default.copyPolygon(start);

      // [(0, 0), (1, 1), (0, 2), (-1, 1)]
      while (true) {
        end = new _sat2.default.Polygon(end.pos.add(new _sat2.default.Vector(0, -this.increment)), [new _sat2.default.Vector(), end.points[1].add(new _sat2.default.Vector(this.increment, this.increment)), end.points[2].add(new _sat2.default.Vector(0, this.increment * 2)), end.points[3].add(new _sat2.default.Vector(-this.increment, this.increment))]);

        if (!verticalFill && end.pos.y <= 0 && end.pos.y + end.points[2].y >= window.innerHeight) verticalFill = _SATUtils2.default.copyPolygon(end);

        if (!horizontalFill && end.pos.x + end.points[1].x > window.innerWidth) horizontalFill = _SATUtils2.default.copyPolygon(end);

        var response = new _sat2.default.Response();
        _sat2.default.testPolygonPolygon(end, windowPoly, response);
    ...
    key: 'createAndRegisterDefaultAnimations',
    value: function createAndRegisterDefaultAnimations() {
      this.createAndRegisterExpandFromCenterAnimation();
      this.createAndRegisterCollapseToCenterAnimation();
    }
  }, {
    key: 'createDiamondAtPoint',
    value: function createDiamondAtPoint(x, y) {
      return new _sat2.default.Polygon(new _sat2.default.Vector(x, y), [new _sat2.default.Vector(), new _sat2.default.Vector(1, 1), new _sat2.default.Vector(0, 2), new _sat2.default.Vector(-1, 1)]);
    }
  }, {
    key: 'createAndRegisterExpandFromPointAnimation',
    value: function createAndRegisterExpandFromPointAnimation(x, y, centerFirst) {
      var verticalFillPercent = '' + ((this.verticalFill.pos.y + this.verticalFill.points[2].y) / (this.end.pos.y + this.end.points[2].y)).toFixed(2) * 100 + '%';
      var start = this.createDiamondAtPoint(x, y);

      var expandDiamondFromPoint = {
        '0%': (0, _static2.default)({
          opacity: 1,
          clipPath: DiamondMaskTransition.generateClipPathString(start),
          zIndex: 999
        }),
        '99%': (0, _static2.default)({
          clipPath: DiamondMaskTransition.generateClipPathString(this.end)
        }),
        '100%': (0, _static2.default)({
          opacity: 1,
          zIndex: 999,
          width: '100%',
          height: '100%'
      ...
      if (centerFirst) {
        expandDiamondFromPoint[verticalFillPercent] = (0, _static2.default)({
    ...
    key: 'createAndRegisterExpandFromCenterAnimation',
    value: function createAndRegisterExpandFromCenterAnimation() {
    ...
    key: 'createAndRegisterCollapseToPointAnimation',
    value: function createAndRegisterCollapseToPointAnimation(x, y, centerFirst) {
      var verticalFillPercent = '' + (1 - ((this.verticalFill.pos.y + this.verticalFill.points[2].y) / (this.end.pos.y + this.end.points[2].y)).toFixed(2)) * 100 + '%';
      var collapsed = this.createDiamondAtPoint(x, y);

      var collapseDiamondToPoint = {
        '0%': (0, _static2.default)({
          clipPath: DiamondMaskTransition.generateClipPathString(this.end),
          opacity: 1,
          zIndex: 1
      ...
      if (centerFirst) {
        collapseDiamondToPoint[verticalFillPercent] = (0, _static2.default)({
          clipPath: DiamondMaskTransition.generateClipPathString(this.verticalFill)
        });
      }
    ...
    key: 'createAndRegisterCollapseToCenterAnimation',
    value: function createAndRegisterCollapseToCenterAnimation(x, y) {
      var collapseDiamondToCenter = {
        '0%': (0, _static2.default)({
          clipPath: DiamondMaskTransition.generateClipPathString(this.end),
          opacity: 1,
          zIndex: 1
    ...
    key: 'getExpandVerticalFillPercent',
    value: function getExpandVerticalFillPercent() {
      return '' + ((this.verticalFill.pos.y + this.verticalFill.points[2].y) / (this.end.pos.y + this.end.points[2].y)).toFixed(2) * 100 + '%';
    }
  }, {
    key: 'getCollapseVerticalFillPercent',
    value: function getCollapseVerticalFillPercent() {
      return '' + (1 - ((this.verticalFill.pos.y + this.verticalFill.points[2].y) / (this.end.pos.y + this.end.points[2].y)).toFixed(2)) * 100 + '%';
    }
  }], [{
    key: 'generateClipPathString',
    value: function generateClipPathString(diamond) {
      var top = diamond.pos,
          right = _SATUtils2.default.functionalAdd(diamond.pos, diamond.points[1]),
          bottom = _SATUtils2.default.functionalAdd(diamond.pos, diamond.points[2]),
          left = _SATUtils2.default.functionalAdd(diamond.pos, diamond.points[3]);

      return 'polygon(' + top.x + 'px ' + top.y + 'px, ' + right.x + 'px ' + right.y + 'px, ' + bottom.x + 'px ' + bottom.y + 'px, ' + left.x + 'px ' + left.y + 'px)';
    }
  }]);

  return DiamondMaskTransition;
}();

exports.default = DiamondMaskTransition;

},{"./SATUtils.js":31,"inline-style-prefixer/static":19,"sat":25}],30:[function(require,module,exports){
'use strict';
...
var _DiamondMaskTransition = require('./DiamondMaskTransition.js');

var _DiamondMaskTransition2 = _interopRequireDefault(_DiamondMaskTransition);

var _CSSAnimationChainer = require('./CSSAnimationChainer.js');
...
var ProjectViewer = function () {
		function ProjectViewer() {
				...
				this.keyframer = new _cssKeyframer2.default({/* options */});
				// Create the DiamondExpansionAnimation
				this.dmt = new _DiamondMaskTransition2.default(this.keyframer);
		...
		_createClass(ProjectViewer, [{
				...
				value: function initEvents() {
						...
						this.$projects.each(function (idx, project) {
								...
								$project.on('click', function () {
										...
										var layoutProp = $project[0].getBoundingClientRect();

										$overlay[0].style['pointer-events'] = 'auto';
										_this.dmt.createAndRegisterExpandFromPointAnimation(window.innerWidth / 2, layoutProp.bottom, true, { fillMode: 'forwards' });

										(0, _CSSAnimationChainer.applyCSSAnimation)($overlay[0], _this.dmt.animations.expandFromPoint, '2000ms', { fillMode: 'forwards' }).then(function () {
												slider = new _slider2.default($slides[0], _this.dmt);
										});

										var titleLayoutProp = $title[0].getBoundingClientRect();
										...
										moveUp[_this.dmt.getExpandVerticalFillPercent()] = (0, _static2.default)({
												left: 0,
												right: 0,
												margin: '0 auto',
												transform: 'translateY(' + (-titleLayoutProp.top + 16) + 'px)'
										});
										_this.keyframer.register("moveUp", moveUp);

										$title[0].style[_this.keyframer.animationProp.js] = "moveUp " + _this.openAnimationTime + " forwards " + _this.timingFunction;

										/*******************************************************/
										var prevLp = (_this.$projects[idx - 1] || $project[0]).getBoundingClientRect();
										var nextLp = (_this.$projects[idx + 1] || $project[0]).getBoundingClientRect();
										...
										var exitUp = {
												...
												'100%': (0, _static2.default)({
														opacity: '0',
														transform: 'translateY(' + _this.dmt.end.pos.y + 'px)'
												})
										};

										exitUp[_this.dmt.getExpandVerticalFillPercent()] = (0, _static2.default)({
												transform: 'translateY(' + (prevLp.top + prevLp.height) + ')',
												opacity: '0.4'
										});

										_this.keyframer.register("exitUp", exitUp);
										...
										var exitDown = {
												...
												'100%': {
														opacity: '0',
														transform: 'translateY(' + (_this.dmt.end.pos.y + _this.dmt.end.points[2].y) + 'px)'
												}
										};
										exitDown[_this.dmt.getExpandVerticalFillPercent()] = {
												transform: 'translateY(' + (_this.dmt.verticalFill.pos.y + _this.dmt.verticalFill.points[2].y) + 'px)',
												opacity: '0'
										};

										_this.keyframer.register("exitDown", exitDown);

										/*******************************************************/

										_this.$projects.each(function (projectIdx, project) {
												if (projectIdx == idx) {
														return true;
												} else if (projectIdx < idx) {
														project.style[_this.keyframer.animationProp.js] = "exitUp " + _this.openAnimationTime + " forwards " + _this.timingFunction;
												} else {
														project.style[_this.keyframer.animationProp.js] = "exitDown " + _this.openAnimationTime + " forwards " + _this.timingFunction;
												}
										});
								});
								...
								$close.on('click', function () {
										...
										_this.dmt.createAndRegisterCollapseToPointAnimation(window.innerWidth / 2, layoutProp.bottom);

										(0, _CSSAnimationChainer.applyCSSAnimation)($overlay[0], _this.dmt.animations.collapseToPoint, '2000ms', { fillMode: 'forwards' }).then(function () {
												slider.destroy();
												slider = null;

												$project.data('isExpanded', false);

												$overlay[0].style[_this.keyframer.animationProp.js] = '';
										});

										/*******************************************************/

										var visibleLayoutProp = $visible[0].getBoundingClientRect();

										var moveDown = (0, _static2.default)({
												'0%': {
														left: 0,
														right: 0,
										...
										moveDown[_this.dmt.getCollapseVerticalFillPercent()] = (0, _static2.default)({
												left: 0,
												right: 0,
												transform: 'translateY(' + (-visibleLayoutProp.top + 11) + 'px)',
												margin: '0 auto'
										...
										_this.keyframer.register("moveDown", moveDown);

										(0, _CSSAnimationChainer.applyCSSAnimation)($title[0], 'moveDown', '2000ms', { fillMode: 'forwards' }).then(function () {
												$title.css({
														position: 'static',
														zIndex: 'auto'
												});
										...
										var enterFromAbove = (0, _static2.default)({
												'0%': {
														opacity: 0,
														transform: 'translateY(' + _this.dmt.end.pos.y + 'px)'
												},
										...
										_this.keyframer.register('enterFromAbove', enterFromAbove);

										var enterFromBelow = (0, _static2.default)({
												'0%': {
														opacity: 0,
														transform: 'translateY(' + (_this.dmt.end.pos.y + _this.dmt.end.points[2].y) + 'px)'
												},
										...
										_this.keyframer.register("enterFromBelow", enterFromBelow);

										_this.$projects.each(function (projectIdx, project) {
												if (projectIdx == idx) {
														return true;
												} else if (projectIdx < idx) {
														(0, _CSSAnimationChainer.applyCSSAnimation)(project, 'enterFromAbove', _this.closeAnimationTime, { fillMode: 'forwards' }).then(function () {
...
},{"./CSSAnimationChainer.js":27,"./DiamondMaskTransition.js":29,"./slider.js":33,"css-keyframer":1,"inline-style-prefixer/static":19,"sat":25,"zepto":26}],31:[function(require,module,exports){
'use strict';
...
var SATUtils = function () {
  function SATUtils() {
    _classCallCheck(this, SATUtils);
  }

  _createClass(SATUtils, null, [{
    key: 'functionalAdd',
    value: function functionalAdd(v1, v2) {
      var v1 = new _sat2.default.Vector().copy(v1);
      return v1.add(v2);
    }
  }, {
    key: 'copyPolygon',
    value: function copyPolygon(polygon) {
      var pos = new _sat2.default.Vector().copy(polygon.pos);
      var points = [];
      ...
      try {
        for (var _iterator = polygon.points[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var copy = new _sat2.default.Vector().copy(point);
          points.push(copy);
        }
      } catch (err) {
      ...
      return new _sat2.default.Polygon(pos, points);
    }
  }]);
...
exports.default = SATUtils;

},{"sat":25}],32:[function(require,module,exports){
'use strict';

var _ProjectViewer = require('./ProjectViewer');
...
var Slider = function () {
	function Slider(wrapper, dmt, opts) {
	...
	_createClass(Slider, [{
		...
		value: function events() {
			...
			this.processScrollEvent = function (e) {
				e.preventDefault();
				if (_this.working) return;

				_this.working = true;
				if (e.deltaY < 0) _this.updatePrevious();
				if (e.deltaY > 0) _this.updateNext();
			};

			this.processClickEvent = function (e) {
				if (_this.working) return;
				if (_DOMUtils2.default.hasClass(e.target, 'arrow')) _this.processBtn(e.target);
			};

			_DOMUtils2.default.addMultiEventListener(this.dom.wrapper, 'DOMMouseScroll mousewheel', this.processScrollEvent);
		...
		value: function destroy() {
			...
			_DOMUtils2.default.removeMultiEventListener(this.dom.wrapper, 'DOMMouseScroll mousewheel', this.processScrollEvent);
			this.dom.wrapper.removeEventListener('click', this.processClickEvent);
			this.dom.slides.forEach(function (slide) {
				_DOMUtils2.default.removeClass(slide, 'showing');
				Object.assign(slide.style, (0, _static2.default)({ animation: '', zIndex: '' }));
			});
			_DOMUtils2.default.addClass(this.dom.slides[0], 'showing');
		}
	}, {
		key: 'processBtn',
		value: function processBtn(btn) {
			if (this.isAuto) {
				this.isAuto = false;
				clearInterval(this.auto);
			}
			if (_DOMUtils2.default.hasClass(btn, 'next')) this.updateNext();
			if (_DOMUtils2.default.hasClass(btn, 'previous')) this.updatePrevious();
		}
  ...
  */
		...
		value: function process() {
			...
			Object.assign(this.dom.current.style, (0, _static2.default)({ animation: '' }));

			(0, _CSSAnimationChainer.applyCSSAnimation)(this.dom.next, this.dmt.animations.expandFromCenter, '2000ms', { fillMode: 'forwards' }).then(function () {
				_this2.dom.current.style.zIndex = 10;
				_DOMUtils2.default.removeClass(_this2.dom.current, 'showing');
				_DOMUtils2.default.addClass(_this2.dom.next, 'showing');
				_this2.dom.current = _this2.dom.next;
				_this2.current = _this2.next;
				_this2.working = false;
				if (_this2.mustDestroy) {
					_this2.destroy();
				}
			});
		}
...
},{"./CSSAnimationChainer.js":27,"./DOMUtils":28,"inline-style-prefixer/static":19,"sat":25}]},{},[32]);
